...
--
-- Table structure for table `phpmysql`
--

CREATE TABLE `phpmysql` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `phpmysql`
--

INSERT INTO `phpmysql` (`id`, `video`, `name`, `clock`, `lesson_number`, `title_desc`, `description`, `image`, `choose`, `fromq`, `toq`) VALUES
...
--
-- Indexes for table `phpmysql`
--
ALTER TABLE `phpmysql`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `phpmysql`
--
ALTER TABLE `phpmysql`
