...
$current_page = str_replace('kidumskill/incCourses/jsjq/jsjq.php?item_id=', '', $current_page);
  ...
  <div class="container-fluid ">
    <div class="row">
      <div class="lesson active">
        ...
        <a href="jsjq.php?item_id=<?php echo $item["id"]; ?>" style="text-decoration: none;" >
