<div class="panel-left">
  ...
  <div class="video_block">
    ...
    <?php if($iduser == $idsub && $statusp == 'Pending') {?>
      ...
      <video width="900" height="550" controls controlsList="nodownload">
    ...
    <div class="row scroll ">
      <div class="exme">
        <form  action="" method="post" class="exme_card" dir="rtl">
          <?php
            for ($e=$fromq; $e < $toq ; $e++) {
            $qe = "select * from questions_jsjq where qid = $e";
            ...
            while ($rowse = mysqli_fetch_array($querye)) { ?>
              <h4 class="card-headerr">
                <?php echo $rowse['question']; ?>
                        ...
                        <?php
            $qe = "select * from answers_jsjq where ans_id =$e";
            $querye = mysqli_query($cone, $qe);
            while ($rowse = mysqli_fetch_array($querye) ){
            ?>
...
<?php           }elseif ($result == 8) {?>
  <div class="success_green">
            <?php    echo "עברתם ";?>
              ...
              <?php
                echo "<p>80</p>";
                $mysqli->query("UPDATE users SET jsjq = jsjq+1 WHERE `username` = '".$username."' "); ?>
                </div>
...
<?php           }else { ?>
          ...
          <?php        $mysqli->query("UPDATE users SET jsjq = jsjq+1 WHERE `username` = '".$username."' ");
                }
                     ?>
                     ...
                     <div class="again start">
                         <input type="button" value="לנסות שוב" onclick="history.back(-1)" class="btn btn-success" />
                            ...
                            <form  action="" method="post">
                                ...
                                <a href="jsjq.php?item_id=<?php echo $item["id"]+1; ?>" class="next" id="next">המשך
                                </a>
                        ...
                        <?php  }else {
                          ...
                          <div class="cert_back scroll">
                            ...
                            <div class="certification">
                              <a href="../../cert/cert.php" class="">לקבלת תעודה</a>
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      <?php           }elseif ($result == 8) {?>
        <div class="success_green">
                  <?php    echo "עברתם ";?>
                    ...
                    <?php
                      echo "<p>80</p>";
                      $mysqli->query("UPDATE users SET  = jsjq+1 WHERE `username` = '".$username."' "); ?>
                      </div>
